...
#define DT_DRV_COMPAT worldsemi_ws2812_spi // Keep compatibility with same DT bindings

#include <rgbw_strip.h> // Switch to rgbw_strip.h
...
#define WS2812_SPI_DEVICE(idx)						 \
	...
	DEVICE_DT_INST_DEFINE(idx,					 \
			      ...
			      POST_KERNEL,				 \
			      CONFIG_RGBW_STRIP_INIT_PRIORITY,		 \
			      &ws2812_spi_api);
